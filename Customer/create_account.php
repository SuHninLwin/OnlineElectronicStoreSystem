    ...
    <main>
        ...
        <section class="login_part section_padding ">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="login_part_form">
                            <div class="login_part_form_iner">
                                <h3>Welcome Our New Customer ! <br>
                                ...
                                <form class="row contact_form" action="#" method="post" novalidate="novalidate">
                                    ...
                                    <div class="col-md-12 form-group p_star">
                                        <input type="text" class="form-control" id="address" name="Customer_Address" value=""
                                            placeholder="Address">
                                    </div>
                                    <div class="col-md-12 form-group p_star">
                                    ...
                                    <div class="col-md-12 form-group p_star">
                                        <input type="password" class="form-control" id="password" name="Customer_Re_Password" value=""
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <button type="submit" value="submit" class="btn_3" name="insert">
                                            Sign Up
			...
			if(isset($_POST['insert']))
			{
			      ...
			      $Customer_Re_Password = $_POST["Customer_Re_Password"];
			      ...
			      if($Customer_Password == $Customer_Re_Password)
			      {
			         ...
			         try
			         {
			             $qy = "INSERT INTO Customer (Customer_Name, Customer_Email, Customer_Phone, Customer_Address, Customer_Password)
                                VALUES('$Customer_Name', '$Customer_Email', '$Customer_Phone', '$Customer_Address', '$Customer_Password')";
			             $db->exec($qy); 

...
<body>
    ...
    <main>
                ...
                <div class="row">
                    <div class="offset-xl-1 col-lg-8">
                        <div class="about-details-cap mb-50">
                            <h4>Our Mission</h4>
                            <p>We offer our customers the right products. We always check the products quality before we deliver to our customer. We also offer the best services. Anytime to support our customers.  </p>
                        </div>

                        <div class="about-details-cap mb-50">
                            <h4>Our Vision</h4>
                            <p>CWe offer all our customers the best price of smartwatches. No high prices, no low quality products, only accurate information and right products.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="video-area">
            <div>
                <img src="images/Gallery&Adv/Adv Fossil.jpeg" width="1500px" height="680px">
            </div>
        </div>
        <!-- Video Area End -->
        <!--? Shop Method Start-->
